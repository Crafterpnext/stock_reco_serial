...
def new_check_expense_account(self,item):
	if not item.get("expense_account"):
		...
		if self.doctype not in ("Purchase Receipt", "Purchase Invoice", "Serialized Stock Reconciliation","Stock Reconciliation", "Stock Entry") and not is_expense_account:
...
class SerializedStockReconciliation(StockController):
	def __init__(self, *args, **kwargs):
		super(SerializedStockReconciliation, self).__init__(*args, **kwargs)
	...
	def on_submit(self):
		...
		for d in self.get("items"):
			...
			if self.doctype == "Stock Entry":
				...
				qty = (d.qty if self.doctype == "Serialized Stock Reconciliation"
					else d.stock_qty)
	...
	def get_gl_entries(self, warehouse_account=None):
		...
		return super(SerializedStockReconciliation, self).get_gl_entries(warehouse_account,
